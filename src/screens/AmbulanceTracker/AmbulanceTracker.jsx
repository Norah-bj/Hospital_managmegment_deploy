...
export const AmbulanceTracker = () => {
  ...
  const ambulanceMapItems = [
    { id: "AMB-00835", title: "Ambulance • Kigali CHUK", lat: -1.9441, lng: 30.0619, popup: "Online" },
    { id: "AMB-00838", title: "Ambulance • Huye", lat: -2.6078, lng: 29.7394, popup: "Offline" },
    { id: "AMB-00841", title: "Ambulance • Musanze", lat: -1.4998, lng: 29.6345, popup: "Maintenance" },
    { id: "AMB-00843", title: "Ambulance • Rusizi", lat: -2.4826, lng: 28.9075, popup: "Offline" },
    { id: "AMB-00840", title: "Ambulance • Muhanga", lat: -2.0723, lng: 29.7599, popup: "Online" },
  ];
        ...
        <div className="grid grid-cols-[1fr_400px] gap-6 mb-6">
          ...
          <Card className="rounded-[3px] border-[0.5px] border-[#0000004c] shadow-[1px_6px_6px_#00000040]">
            <CardContent className="p-6">
              <Map center={[-1.9536, 30.0619]} zoom={7} items={ambulanceMapItems} />
            </CardContent>
          </Card>
