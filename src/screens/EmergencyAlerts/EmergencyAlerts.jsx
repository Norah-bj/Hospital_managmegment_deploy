...
import { fetchEmergencies as apiFetchEmergencies } from "../../api/emergencyService";
...
// Legend items (match map marker colors exactly)
const legendItems = [
  { color: "bg-[#ef4444]", label: "Critical" },
  { color: "bg-[#f97316]", label: "Urgent" },
  { color: "bg-[#facc15]", label: "Moderate" },
  { color: "bg-[#22c55e]", label: "Available" },
  // { color: "bg-[#3b82f6]", label: "In Transit" },
];
...
export const EmergencyAlerts = () => {
  ...
  const getStatusBadgeColor = (status) => {
    switch (status) {
      case "Critical":
        return "bg-[#fee2e2] text-[#ef4444]"; // light red bg, red text
      case "Urgent":
        return "bg-[#ffedd5] text-[#f97316]"; // light orange bg, orange text
      case "Moderate":
        return "bg-[#fef9c3] text-[#facc15]"; // light yellow bg, yellow text
      case "Available":
        return "bg-[#dcfce7] text-[#22c55e]"; // light green bg, green text
      case "In Transit":
  ...
  // Map markers (sample coordinates in Rwanda)
  const emergencyMapItems = [
    { id: 101, type: "emergency", status: "Critical", title: "Critical • Nyamirambo", lat: -1.9731, lng: 30.0447 },
    { id: 102, type: "emergency", status: "Urgent", title: "Urgent • Remera", lat: -1.9555, lng: 30.1291 },
    { id: 103, type: "emergency", status: "Moderate", title: "Moderate • Gikondo", lat: -1.9962, lng: 30.0936 },
    { id: 104, type: "emergency", status: "Available", title: "Available • Kicukiro", lat: -1.9900, lng: 30.1340 },
  ];
    ...
    <div className="flex-1 flex flex-col">
      ...
      <div className="flex-1 p-4 overflow-auto">
        ...
        <div className="grid grid-cols-2 gap-4 mb-6">
          ...
          <Card className="rounded-[3px] border-[0.5px] border-[#0000004c] shadow-[1px_6px_6px_#00000040]">
            <CardContent className="p-6">
              <Map center={[-1.9536, 30.0619]} zoom={7} items={emergencyMapItems} />
